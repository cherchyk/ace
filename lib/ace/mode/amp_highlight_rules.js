...
define(function(require, exports, module) {
	...
	var AmpLangHighlightRules = function() {
		...
		var keywords = lang.arrayToMap(
			('set|var|abstract|and|array|as|break|case|catch|class|clone|const|continue|declare|default|do|else|elseif|empty|enddeclare|endfor|endforeach|endif|' +
				'endswitch|endwhile|extends|final|for|foreach|function|global|goto|if|implements|interface|instanceof|namespace|next|new|not|or|private|protected|' +
				'public|static|switch|throw|then|to|trait|try|use|var|while|xor').split('|')
		);
