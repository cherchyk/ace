...
module.exports = {
    "test: inline mode" : function() {
        ...
        var tokens = tokenizer.getLineTokens("'juhu kinners' ?> html  <? 'amp'", "start").tokens;
        ...
        tokens = tokenizer.getLineTokens("'juhu kinners' ?> html  <? 'amp'", "start").tokens;
